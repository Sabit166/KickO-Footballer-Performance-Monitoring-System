...
player_stats_bp = Blueprint('player_performance', __name__)

@player_stats_bp.route('/player_performance', methods=['GET'])
def get_stats():
    db = get_db()
...
@player_stats_bp.route('/player_performance/<int:player_id>', methods=['PUT'])
...
@player_stats_bp.route('/player_performance/<int:player_id>', methods=['DELETE'])
